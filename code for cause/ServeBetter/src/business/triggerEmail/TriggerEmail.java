...
public class TriggerEmail {
    ...
    public static void labTestResultEmail(String doctorEmail, String name, String PatientId) {
        ...
        final String username = "do.not.reply.community.service@gmail.com";
        final String password = "CommunityService5*";
        ...
        try {
            ...
            message.setFrom(new InternetAddress("do.not.reply.community.service@gmail.com"));
